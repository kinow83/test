 ...
 *
 * Version:	$Id: filters.c,v 1.1.1.1 2006/02/24 08:09:18 cvs Exp $
 *
...
static const char rcsid[] = "$Id: filters.c,v 1.1.1.1 2006/02/24 08:09:18 cvs Exp $";
...
typedef struct ascend_ip_filter_t {
	...
	uint8_t		srcPortComp;
	uint8_t		dstPortComp;
	unsigned BYTE   fill[4];        /* used to be fill[2] */
} ascend_ip_filter_t;
