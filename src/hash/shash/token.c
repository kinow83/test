 ...
 *
 * Version:	$Id: token.c,v 1.1.1.1 2006/02/24 08:09:18 cvs Exp $
 *
...
static const char rcsid[] = "$Id: token.c,v 1.1.1.1 2006/02/24 08:09:18 cvs Exp $";
 ...
 */
const char *lrad_int2str(const LRAD_NAME_NUMBER *table, int number, const char *def)
{
	const LRAD_NAME_NUMBER *this;
...
const char *packet_type_int2str(const PACKET_CODE_TYPE *table, int number, const char *def)
{
	const PACKET_CODE_TYPE *this;
