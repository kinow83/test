 ...
 *
 * Version: $Id: udpfromto.c,v 1.1.1.1 2006/02/24 08:09:18 cvs Exp $
 */

#include "autoconf.h"

#ifdef WITH_UDPFROMTO
static const char rcsid[] = "$Id: udpfromto.c,v 1.1.1.1 2006/02/24 08:09:18 cvs Exp $";
			  ...
			  struct sockaddr *to, socklen_t tolen)
{
	...
	struct iovec iov;
# ifdef HAVE_IP_PKTINFO
	BYTE cmsgbuf[CMSG_SPACE(sizeof(struct in_pktinfo))];
	struct in_pktinfo pktinfo, *pktinfo_ptr;
	memset(&pktinfo, 0, sizeof(struct in_pktinfo));
# endif

# ifdef HAVE_IP_SENDSRCADDR
	BYTE cmsgbuf[CMSG_SPACE(sizeof(struct in_addr))];
# endif
