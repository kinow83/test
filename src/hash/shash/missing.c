 ...
 *
 * Version:	$Id: missing.c,v 1.1.1.1 2006/02/24 08:09:18 cvs Exp $
 *
...
static const char rcsid[] = "$Id: missing.c,v 1.1.1.1 2006/02/24 08:09:18 cvs Exp $";
...
{
  strncpy(l_buf, ctime(l_clock), 26);
