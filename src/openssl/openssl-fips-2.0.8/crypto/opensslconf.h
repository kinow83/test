...
#define ENGINESDIR "/root/git/test/src/openssl/openssl-fips-2.0.8/../ssl/fips2.0/lib/engines"
#define OPENSSLDIR "/root/git/test/src/openssl/openssl-fips-2.0.8/../ssl/fips2.0"
#endif
#endif
