...
// gcc test_cipher_enc.c string_util.c -o test_cipher_enc -lssl -lcrypto
...
int main(int argc, char* argv[])
{
	...
	BIO_printf(errBIO, "blowfish encrypt evp - OK\n");

	// add block padding
	unsigned char * outbuf
		= (unsigned char*)malloc(
				sizeof(unsigned char) * (len + EVP_CIPHER_CTX_block_size(&ctx)));
	int outlen, tmplen;
