...
{
       0,     0,     3,     5,     7,    11,    12,    13,    18,    19,
      24,    26,    29,    32,    34,    36,    40,    42,    44
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      12,     0,    -1,    13,    -1,    14,    -1,    13,     3,    14,
      -1,    -1,    -1,     4,     5,    15,    17,    -1,    -1,     4,
       6,    16,    17,    -1,    18,    -1,     7,     4,    -1,     8,
       4,    -1,     9,    -1,    19,    -1,    18,    10,    19,    -1,
      20,    -1,     4,    -1,    20,     4,    -1
};
...
{
       0,   127,   127,   130,   134,   141,   144,   144,   152,   152,
     162,   163,   168,   173,   179,   184,   191,   197,   202
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$@2", "address_group", "address_list", "address", "string_list", YY_NULL
};
#endif
...
#define yypact_value_is_default(ali_yystate) \
  ((ali_yystate) == (-9))
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, YYLTYPE *yylsp, int ali_yyrule)
#else
static void
yy_reduce_print (yyvsp, yylsp, ali_yyrule)
    YYSTYPE *yyvsp;
    YYLTYPE *yylsp;
    int ali_yyrule;
#endif
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr, yyrhs[yyprhs[ali_yyrule] + yyi],
		       &(yyvsp[(yyi + 1) - (yynrhs)])
		       , &(yylsp[(yyi + 1) - (yynrhs)])		       );
      YYFPRINTF (stderr, "\n");
    }
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N), yylsp -= (N))
  ...
  ali_yylloc.first_line   = ali_yylloc.last_line   = 1;
  ali_yylloc.first_column = ali_yylloc.last_column = 1;
#endif
...
/* Line 1810 of yacc.c  */
#line 131 "mh_alias_gram.y"
    {
		 ali_append ((yyvsp[(1) - (1)].alias));
	       }
    break;
...
/* Line 1810 of yacc.c  */
#line 135 "mh_alias_gram.y"
    {
		 ali_append ((yyvsp[(3) - (3)].alias));
	       }
    break;
...
/* Line 1810 of yacc.c  */
#line 145 "mh_alias_gram.y"
    {
		 ali_verbatim (0);
		 (ali_yyval.alias) = mu_alloc (sizeof (*(ali_yyval.alias)));
		 (ali_yyval.alias)->name = (yyvsp[(1) - (4)].string);
		 (ali_yyval.alias)->rcpt_list = (yyvsp[(4) - (4)].list);
...
/* Line 1810 of yacc.c  */
#line 164 "mh_alias_gram.y"
    {
		 (ali_yyval.list) = unix_group_to_list ((yyvsp[(2) - (2)].string));
...
/* Line 1810 of yacc.c  */
#line 169 "mh_alias_gram.y"
    {
		 (ali_yyval.list) = unix_gid_to_list ((yyvsp[(2) - (2)].string));
		 free ((yyvsp[(2) - (2)].string));
	       }
    break;
...
/* Line 1810 of yacc.c  */
#line 180 "mh_alias_gram.y"
    {
		 (ali_yyval.list) = list_create_or_die ();
		 mu_list_append ((ali_yyval.list), (yyvsp[(1) - (1)].string));
	       }
    break;
...
/* Line 1810 of yacc.c  */
#line 185 "mh_alias_gram.y"
    {
		 mu_list_append ((yyvsp[(1) - (3)].list), (yyvsp[(3) - (3)].string));
		 (ali_yyval.list) = (yyvsp[(1) - (3)].list);
	       }
    break;
...
/* Line 1810 of yacc.c  */
#line 192 "mh_alias_gram.y"
    {
		 (ali_yyval.string) = ali_list_to_string (&(yyvsp[(1) - (1)].list));
	       }
    break;
...
/* Line 1810 of yacc.c  */
#line 203 "mh_alias_gram.y"
    {
		 mu_list_append((yyvsp[(1) - (2)].list), (yyvsp[(2) - (2)].string));
		 (ali_yyval.list) = (yyvsp[(1) - (2)].list);
	       }
    break;
